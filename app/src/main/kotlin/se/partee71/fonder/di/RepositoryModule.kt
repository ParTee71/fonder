...
import se.partee71.fonder.data.repository.RoomSwitchWatchRepository
...
abstract class RepositoryModule {
    ...
    @Binds
    abstract fun bindSwitchWatchRepository(impl: RoomSwitchWatchRepository): SwitchWatchRepository
