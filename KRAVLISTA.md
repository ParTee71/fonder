...
- **Procenten överst hade ingen historik och ingen måttstock (#96):** Nya rader **HEM-9**
  ...
  5. **Serierna indexeras inte till 100 som i ANA-11.** Indexering löser att två *kurser* inte
     ...
     etiketternas tecken.
  6. **Referensfonden fick en väg fram redan första dagen.** Först satte bara backstopen
  ...
  7. **Tre hämtningar blev en.** Hem läste redan samma fonds kurshistorik två gånger per
