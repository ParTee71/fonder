...
>
> Version: 0.21.2 · Paket: `se.partee71.fonder` · Språk: Svenska
...
| TP-19 | **All cachad NAV är i kronor** (`FundPrice.VALUE_CURRENCY`). Värdekedjan — portföljvärde, vinst/förlust, dag/vecka/månad, analys — räknar i kronor utan någon valutakonvertering, så en kurs i annan valuta får aldrig cachas: den skulle tyst tolkas som kronor och ge ett värde fel med hela växelkursen (issue #41). Källor som levererar fondens egen valuta (fondlista, TP-18) filtreras i repository-lagret och lämnar fonden till en källa som ger kronor (Avanza, TP-14). Har ingen källa kurser i kronor visas hellre "kurs saknas" än ett felaktigt värde (POR-3). Riktig valutakonvertering med historiska växelkurser är medvetet inte byggd. |
