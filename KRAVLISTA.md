...
- **Procenten överst hade ingen historik och ingen måttstock (#96):** Nya rader **HEM-9**
  ...
  5. **Procentläget fick inte ärva kursdiagrammets regler.** `PriceRangeProvider` undviker med
     flit nollinjen (#49) eftersom fondkurser aldrig är i närheten av noll — för en
     avkastningskurva är det tvärtom, och utan nollinjen ser en förlust ut som en vinst. Av samma
     skäl indexeras serierna **inte** till 100 som i ANA-11: det hade räknat bort just den
     skillnad jämförelsen finns för.
  6. **Tre hämtningar blev en.** Hem läste redan samma fonds kurshistorik två gånger per
