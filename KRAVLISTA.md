...
Molnbackupen (TP-7 steg 2) väntar på att `drive.appdata`-scopet tas i bruk; den lokala rundturen
finns sedan SET-6 och formatet ändras inte av att transporten byts. Google-inloggningen (TP-6) är
byggd sedan issue #106 och är den förutsättning som återstod. Konsolstegen för båda — Firebase-projekt,
